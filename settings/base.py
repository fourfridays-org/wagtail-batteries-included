...
WAGTAIL_SITE_NAME = os.environ.get('WAGTAIL_SITE_NAME', default='')

FLICKR_API_KEY = os.environ.get('FLICKR_API_KEY', default='')
FLICKR_API_SECRET = os.environ.get('FLICKR_API_SECRET', default='')
FLICKR_API_USER = os.environ.get('FLICKR_API_USER', default='')
